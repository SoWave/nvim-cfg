...
return {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>sw", '<cmd>telescope live_grep default_text=<c-r>z<cr>', desc = "word (root dir)" },
      { "<leader>sw", '<cmd>telescope live_grep default_text=<c-r>z<cr>', mode = "v", desc = "selection (root dir)" },
      {
        "<leader>ss",
        function()
